			...
			<div class="col-xs-12 col-sm-12 col-md-12">
				...
				<div class="carousel carousel-showmanymoveone slide" id="itemslider">
					...
					<div id="slider-control">
						<a class="left carousel-control" href="#itemslider" data-slide="prev"><img src="https://s12.postimg.org/uj3ffq90d/arrow_left.png" alt="L" class="img-responsive"></a>
						<a class="right carousel-control" href="#itemslider" data-slide="next"><img src="https://s12.postimg.org/djuh0gxst/arrow_right.png" alt="R" class="img-responsive"></a>
					</div>
				</div>
			</div>
		</div>
